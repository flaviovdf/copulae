...
The `twod`, `nd` and `training` modules are probably the
ones you'll  need.

twod: trains copula networks for two dimensional datasets

nd: trains copula networks for n-dimesional datasets.
    Builds on the two dimensional (twod) module.

training: functions for training the network.
